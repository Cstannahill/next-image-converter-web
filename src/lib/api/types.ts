...
export function validateImageFormat(
  data: unknown
): { success: true; data: ImageFormat } | { success: false; errors: string[] } {
  ...
  if (!result.success) {
    ...
    return {
      ...
      errors:
        issues.length > 0
          ? issues.map((iss: z.core.$ZodIssue) =>
 ...
 */
export function createBrandedImageFormat(
  data: ImageFormat
): BrandedImageFormat {
 ...
 */
export const BodyBatchConvertImagesConvertBatchPostSchema = z
  .object({
 ...
 */
export function validateBodyBatchConvertImagesConvertBatchPost(
  data: unknown
):
  | { success: true; data: BodyBatchConvertImagesConvertBatchPost }
  ...
  return {
    success: true,
    data: result.data as BodyBatchConvertImagesConvertBatchPost,
  };
}
 ...
 */
export function parseBodyBatchConvertImagesConvertBatchPost(
  data: unknown
): BodyBatchConvertImagesConvertBatchPost {
  return BodyBatchConvertImagesConvertBatchPostSchema.parse(
    data
  ) as BodyBatchConvertImagesConvertBatchPost;
}

/**
 * Branded type for BodyBatchConvertImagesConvertBatchPost with compile-time guarantees
 */
export type BrandedBodyBatchConvertImagesConvertBatchPost =
  BodyBatchConvertImagesConvertBatchPost & {
    __brand: "BodyBatchConvertImagesConvertBatchPost";
  };

/**
 * Create a branded BodyBatchConvertImagesConvertBatchPost instance
 */
export function createBrandedBodyBatchConvertImagesConvertBatchPost(
  data: BodyBatchConvertImagesConvertBatchPost
): BrandedBodyBatchConvertImagesConvertBatchPost {
 ...
 */
export function isBodyBatchConvertImagesConvertBatchPost(
  value: unknown
): value is BodyBatchConvertImagesConvertBatchPost {
 ...
 */
export const BodyConvertImageConvertPostSchema = z
  .object({
    file: z.string(),
    target_format: ImageFormatSchema,
    quality: z.unknown().optional(),
 ...
 */
export function validateBodyConvertImageConvertPost(
  data: unknown
):
  | { success: true; data: BodyConvertImageConvertPost }
  | { success: false; errors: string[] } {
 ...
 */
export function parseBodyConvertImageConvertPost(
  data: unknown
): BodyConvertImageConvertPost {
  return BodyConvertImageConvertPostSchema.parse(
    data
  ) as BodyConvertImageConvertPost;
}

/**
 * Branded type for BodyConvertImageConvertPost with compile-time guarantees
 */
export type BrandedBodyConvertImageConvertPost = BodyConvertImageConvertPost & {
  __brand: "BodyConvertImageConvertPost";
};

/**
 * Create a branded BodyConvertImageConvertPost instance
 */
export function createBrandedBodyConvertImageConvertPost(
  data: BodyConvertImageConvertPost
): BrandedBodyConvertImageConvertPost {
  return data as BrandedBodyConvertImageConvertPost;
}
/**
 * Runtime type guard for BodyConvertImageConvertPost
 */
export function isBodyConvertImageConvertPost(
  value: unknown
): value is BodyConvertImageConvertPost {
 ...
 */
export function validateValidationError(
  data: unknown
):
  | { success: true; data: ValidationError }
  | { success: false; errors: string[] } {
 ...
 */
export type BrandedValidationError = ValidationError & {
  __brand: "ValidationError";
};

/**
 * Create a branded ValidationError instance
 */
export function createBrandedValidationError(
 ...
 */
export function validateHTTPValidationError(
  data: unknown
):
  | { success: true; data: HTTPValidationError }
  | { success: false; errors: string[] } {
 ...
 */
export type BrandedHTTPValidationError = HTTPValidationError & {
  __brand: "HTTPValidationError";
};

/**
 * Create a branded HTTPValidationError instance
 */
export function createBrandedHTTPValidationError(
  data: HTTPValidationError
): BrandedHTTPValidationError {
...
export function validateHealthResponse(
  ...
  | { success: true; data: HealthResponse }
  | { success: false; errors: string[] } {
 ...
 */
export type BrandedHealthResponse = HealthResponse & {
  __brand: "HealthResponse";
};

/**
 * Create a branded HealthResponse instance
 */
export function createBrandedHealthResponse(
  data: HealthResponse
): BrandedHealthResponse {
